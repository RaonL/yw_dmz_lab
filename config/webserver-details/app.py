...
# FIX: 기본값을 DMZ.yml/variables.sh의 실제 값으로 통일
DB_HOST = os.getenv('DB_HOST', '10.0.2.20')       # DMZ_DB_ETH1_IP (CIDR 제거)
DB_NAME = os.getenv('DB_NAME', 'webapp')           # POSTGRES_DB 와 일치
DB_USER = os.getenv('DB_USER', 'postgres')         # postgres 기본 superuser
DB_PASSWORD = os.getenv('DB_PASSWORD', 'admin123') # POSTGRES_PASSWORD 와 일치
